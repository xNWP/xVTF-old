		...
		namespace Bitmap
		{
			namespace ImageFile
			{
				...
				namespace VTF
				{
					...
					{
					public:
						VTFResource(const xvtf::Bitmap::VTF::VTFResource_r &res);
						~VTFResource();
						!VTFResource();
					...
					private:
						xvtf::Bitmap::VTF::VTFResource_r*_raw;
					};
				}
				...
				public:
					...
					float GetBumpScale();
					xvtf::CLI::ImageFile::VTF::ImageFormat GetFormat();
					unsigned short GetNumberOfMipLevels();
					xvtf::CLI::ImageFile::VTF::ImageFormat GetLowResFormat();
					...
					array<xvtf::CLI::ImageFile::Resolution>^ GetResolutions();
				...
				private:
					xvtf::Bitmap::VTF::VTFFileHeader* _header;
					xvtf::Bitmap::VTFFile* _impl;
				};
			}
		}
	}
